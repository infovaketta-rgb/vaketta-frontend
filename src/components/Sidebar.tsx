        ...
        <nav className="flex flex-1 flex-col gap-6 overflow-y-auto px-3 py-5">
          <div>
            ...
            <ul className="flex flex-col gap-0.5">
              ...
              <NavItem href="/dashboard/templates" label="Templates" onClick={onClose} icon={
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
              } />
              <NavItem href="/dashboard/saved-replies" label="Saved Replies" onClick={onClose} icon={
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
                    d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
                </svg>
              } />
              <NavItem href="/dashboard/media" label="Media" onClick={onClose} icon={
                <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
