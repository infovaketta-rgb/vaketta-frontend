...
export default function JumpNode({ data, selected }: NodeProps<any>) {
  ...
  return (
    <div className={`w-48 rounded-xl border-2 bg-white shadow-md transition ${
      ...
      <div className="rounded-t-[10px] bg-violet-50 border-b border-violet-100 px-3 py-1.5 flex items-center gap-1.5">
        <span className="text-sm leading-none">↩</span>
        <span className="text-[10px] font-bold uppercase tracking-widest text-violet-600">Jump</span>
      </div>
