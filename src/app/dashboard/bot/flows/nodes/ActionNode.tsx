...
export default function ActionNode({ data, selected }: NodeProps<any>) {
  ...
  return (
    <div className={`w-52 rounded-xl border-2 bg-white shadow-md transition ${
      ...
      <div className="rounded-t-[10px] bg-orange-50 border-b border-orange-100 px-3 py-1.5 flex items-center gap-1.5">
        <span className="text-sm leading-none">⚡</span>
        <span className="text-[10px] font-bold uppercase tracking-widest text-orange-500">Action</span>
      </div>
      <div className="px-3 py-2 space-y-1.5">
        ...
        {d?.actionType === "set_variable" && d?.variableToSet && (
          <p className="text-[10px] text-orange-700 font-mono truncate">
