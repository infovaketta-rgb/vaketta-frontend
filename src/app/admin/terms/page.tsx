...
export default function TermsAdminPage() {
  ...
  async function handleSave() {
    ...
    try {
      await adminApiFetch("/admin/terms-of-service", {
        method: "PATCH",
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 p-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#0C1B33]">Terms of Service</h1>
          <p className="mt-1 text-sm text-slate-500">Edit the public-facing Terms of Service. Changes take effect immediately.</p>
        </div>
