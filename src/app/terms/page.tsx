        ...
        {loading ? (
          ...
          <div className="overflow-hidden rounded-2xl border border-[#E5E0D4] bg-white shadow-sm">
            <div className="border-b border-[#E5E0D4] bg-[#0C1B33] px-10 py-10 text-center">
              ...
              <p className="mt-1 text-lg font-medium text-[#B8912E]">Terms of Service</p>
              {doc.effectiveDate && (
            ...
            <div className="border-b border-[#E5E0D4] bg-[#F4F2ED] px-10 py-6 text-sm text-[#0C1B33]/70 leading-relaxed">
              Please read these Terms of Service carefully before using Vaketta. By accessing or using our platform, you agree to be bound by these terms. If you do not agree, please do not use the service.
              <br /><br />
              Vaketta is operated by a solo founder based in Varkala, Kerala, India. For questions, contact us at <a href="mailto:infovaketta@gmail.com" className="text-[#1B52A8] underline">infovaketta@gmail.com</a>.
            </div>
